...
import by.jrr.jdbc.bean.Contact;
...
public class DeveloperRunnerOto {
    private static SessionFactory sessionFactory;

    public static void main(String[] args) {
        sessionFactory = new Configuration().configure().buildSessionFactory();
        DeveloperRunnerOto developerRunner = new DeveloperRunnerOto();

        System.out.println("Adding contact information...");
        Contact contact1 = developerRunner.addContact("Some address", "Dnipropetrovsk", "+31111111", "234234@yahoo.com");
        Contact contact2 = developerRunner.addContact("One More address", "Kyiv", "+380667654321", "@mail.com");
        ...
        Integer developerId2 = developerRunner.addDeveloper("Peter", "Programmer", "C++ Developer", 2, contact1);
